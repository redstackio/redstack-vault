...
name: Installation of RPO tool
type: command
executor: bash
data: wget https://github.com/Netflix/recipes-rss/blob/master/eng/tools/rpo-2.0.0-SNAPSHOT-jar-with-dependencies.jar?raw=true
  -O rpo.jar
output: null
