...
name: gcc-compile-malicious-dll-x86
type: command
executor: bash
data: i686-w64-mingw32-gcc $_SOURCE_C -shared -o $_OUTPUT_DLL
output: null
...
# gcc-compile-malicious-dll-x86

## Command

```bash
i686-w64-mingw32-gcc $_SOURCE_C -shared -o $_OUTPUT_DLL
```

## Description

Compiles a C source file into a 32-bit Windows DLL using MinGW cross-compiler, targeted at x86 Windows services for hijacking.
...
No output on success; generates 32-bit malicious.dll.
