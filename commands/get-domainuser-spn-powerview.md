...
name: get-domainuser-spn-powerview
type: command
executor: powershell
...
This PowerShell command from PowerView enumerates domain users with Service Principal Names (SPNs), providing detailed AD object properties for Kerberoasting target identification.

## Parameters

| Parameter | Description | Required |
|-----------|-------------|----------|
| -SPN | Filters for users with populated servicePrincipalName | Yes |
...
objectsid             : S-1-5-21-1576920733-1301476157-954876328-1108
samaccountname        : svc-mssql
... (detailed AD properties including serviceprincipalname)
