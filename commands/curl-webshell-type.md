...
output: >-
  ...
  ...> [C# source code] </textarea></body></html>
executor: bash
platforms:
  - Linux
  - Windows
...
updated_at: '2025-12-14T05:32:22.918Z'
verified: false
validated: true
submitted: true
---
...
Sends a GET request to the ASP webshell with URL-encoded type command to retrieve file contents, using cookies for session persistence.
...
| -b | Cookies | Yes |
| URL | Webshell with encoded getsc | Yes |
...
Adapt path for other files.

## Expected Output

HTTP response with source code in textarea.
