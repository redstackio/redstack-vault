...
output: >-
  ...
  |   /dev/: Potentially interesting directory w/ listing on 'apache/2.2.22
  (ubuntu)'
  ...
  # Nmap done at Mon Nov 25 12:28:55 2019 -- 1 IP address (1 host up) scanned in
  694.61 seconds
...
Scans the target with Nmap's vulnerability NSE scripts to detect CVEs like Heartbleed.
...
| -script vuln | Run vulnerability scripts | Built-in |
...
Detailed vuln reports per port, e.g., VULNERABLE: Heartbleed.

## Related

- [[procedures/port-scan-with-vulnerability-enumeration]]
- [[tools/Nmap]]
